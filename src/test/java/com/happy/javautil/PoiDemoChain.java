...
//        sheetPro.protectSheet("123456");

        //设置列宽度
        sheetPro.setColumnWidth(0,30*256);
        sheetPro.setColumnWidth(0,30*256);
        sheetPro.setColumnWidth(0,30*256);
        sheetPro.setColumnWidth(0,30*256);
        ...
        row0.createCell(2).setCellValue("人");
        row0.createCell(3).setCellValue("吴");

//        Row row22 = sheetPro.createRow(22);
//        Cell cell225=row22.createCell(5);
//        cell225.setCellValue("aaa");

//        XSSFCellStyle alterableStyle = (XSSFCellStyle)book.createCellStyle();
//        alterableStyle.setLocked(false);

//        cell225.setCellStyle(alterableStyle);
        ...
        areaMap.put("三帽子省",countyYancheng);
        areaMap.put("二愣子",countyLiuhe);
...
//        book.setSheetHidden(book.getSheetIndex(hideSheet), true);
        ...
        // 设置第一行，存省的信息  
        Row provinceRow = hideSheet.createRow(rowId.getAndIncrement());
...
//        }
        ...
        areaMap.keySet().forEach(x->{
            String[] son = areaMap.get(x);
...
//        XSSFRow xssfRow=sheetPro.createRow(2);
//        xssfRow.setRowStyle(alterableStyle);
//        Cell cell=xssfRow.createCell(0);
//        cell.setCellValue("aaaa");
//        cell.setCellStyle(alterableStyle);
//        xssfRow.createCell(1).setCellValue("aaaa");
//        
//        xssfRow.createCell(2).setCellValue("bbbbc");

//        sheetPro.setColumnHidden(2, true);
